...
public class AuthEntryPointJwt implements AuthenticationEntryPoint {
    ...
    private String getCustomMessage(AuthenticationException authException, HttpServletRequest request) {
        ...
        if (message.contains("JWT") || message.contains("token")) {
            ...
            if (authHeader == null) return "Missing Authorization header";
            else if (!authHeader.startsWith("Bearer ")) return "Invalid Authorization header format";
            else return "Invalid or expired JWT token";
        }
